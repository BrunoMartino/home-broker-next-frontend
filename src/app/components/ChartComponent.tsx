...
export function ChartComponent(props: {
  ...
  useEffect(() => {
    ...
    seriesRef.current.setData([
      { time: "2025-04-22", value: 32.51 },
      { time: "2025-04-23", value: 31.11 },
      { time: "2025-04-24", value: 27.02 },
      { time: "2025-04-25", value: 27.32 },
      { time: "2025-04-26", value: 25.17 },
      { time: "2025-04-27", value: 28.89 },
      { time: "2025-04-28", value: 25.46 },
      { time: "2025-04-29", value: 23.92 },
      { time: "2025-04-30", value: 22.68 },
      { time: "2025-04-31", value: 22.67 },
    ]);
  }, [data]);
